...
#      19 Vagrant 
########################################################  
docker pull docznet2/otus_homeworks
docker run -d -p 80:80 docker pull docznet2/otus_homeworks


#Определите разницу между контейнером и образом
#Вывод опишите в домашнем задании.
 Контейнер - выполняющийся на хосте образ - он же - изолированное ПО и его окружение
 Образ - архив, содержащий минимальное userspace окружение, для запуска конкретного ПО

#Ответьте на вопрос: Можно ли в контейнере собрать ядро?
 Нет, нельзя, контейнер использует ресурсы уже существующей и выполняющейся операционной системы.